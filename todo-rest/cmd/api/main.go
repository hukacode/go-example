...
import (
	...
	"hukaapp/todo/internal/jsonlog"
	"hukaapp/todo/internal/mailer"
	"os"
	"runtime"
	"strings"
	"sync"
...
func main() {
	...
	flag.StringVar(&cfg.env, "env", "dev", "Environment (dev|int|prd)")
	...
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Todo app <no-reply@todoapp.com>", "SMTP sender")
